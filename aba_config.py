...
from modulos.recursos.utilitarios import carregar_configuracoes, salvar_configuracoes
# importação após reestruturação do projeto
...
def atualizar_imagem_porte(porte):
    ...
    if os.path.exists(caminho):
        ...
        from recursos.utils_imagem import fade_in_imagem  # ou importe de onde salvou
