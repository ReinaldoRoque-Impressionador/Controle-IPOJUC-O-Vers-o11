...
from modulos.abas.menu_lateral import menu_lateral
...
from modulos.abas.dados_compartilhados import <variáveis ou funções compartilhadas>

# específicamente para abas financeiro e relatórios
from modulos.banco.db_models import Pagamento, Cliente
from modulos.banco.database import database
from modulos.recursos.centro_controle_relatórios import gerar_relatorio_pdf, gerar_excel
from recursos.aba_itau import gerar_token_pagamento  # ⚠️ verificar importação circular
from modulos.abas.mensageiro import enviar_mensagem_whatsapp
# específicamente para abas financeiro e relatórios.

# específicamente para a aba_relatorios
from modulos.recursos.centro_controle_relatórios import gerar_relatorio_pdf, gerar_excel
from modulos.abas.aba_financeiro import obter_dados_financeiros  # ⚠️ circular?
from modulos.abas.mensageiro import enviar_mensagem_whatsapp
#especificamente para a aba_relatorios
...
def chamar_aba_relatorios(notebook):
    frame = criar_aba_relatorios(notebook)
